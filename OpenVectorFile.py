...
class MyFrame1 ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = "open Vector File" , pos = wx.DefaultPosition, size = wx.Size( 665,408 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		self.m_propertyGrid3.Append( pg.ArrayStringProperty("Select Vector Type ",value=["string","string"]) )  
